...
class APIManager {
  ...
  // static String baseUrl = 'http://10.0.0.101:6001/'; // local
  static String baseUrl = 'http://157.245.107.181:6001/'; // live
  ...
  Future<dynamic> postAPICall(String url, Map param) async {
    ...
    try {
      ...
      var headers = GetStorage().read(userData) == null
          ...
          : {"Content-Type": "application/json", "Authorization": "Bearer " + LoginSuccessModel.fromJson(GetStorage().read(userData)).data!.token!};
